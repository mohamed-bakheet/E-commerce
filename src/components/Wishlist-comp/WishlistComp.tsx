      ...
      {wishList?.data.map((item) => (
        ...
        >
          <div className="lg:col-span-2 flex justify-center w-full  p-5 h-max">
            <Image
              src={item.imageCover || "/placeholder.png"} // Fallback to a placeholder image
              alt={item.title || "Product image"} // Fallback for alt text
              width={300}
              height={200}
          ...
          <div className="lg:col-span-8 flex flex-col lg:flex-row justify-between  p-5  h-max">
            <div className="flex flex-col text-start gap-5">
              ...
              <div
                ...
                className="flex items-center gap-3 cursor-pointer text-red-600 mb-8"
              >
                <Trash2 />
                <h2> Remove</h2>
              </div>
